...
//            [techs.bemtree, { devMode: process.env.BEMTREE_ENV === 'development' }],
            ...
            [techs.fileMerge, {
                target: '?.pre.js',
                sources: ['?.bemhtml.js'/*'?.browser.bemhtml.js'*/, '?.browser.js']
            }],
            [techs.prependYm, { source: '?.pre.js' }],

            // node.js
            [techs.nodeJs],
            [techs.prependYm, { source: '?.node.js', target : '?.nodeWithYm.js' }],

            // borschik
            [techs.borschik, { sourceTarget: '?.js', destTarget: '_?.js', freeze: true, minify: isProd }],
            [techs.borschik, { sourceTarget: '?.nodeWithYm.js', destTarget: '_?.node.js', freeze: true, minify: isProd }],
